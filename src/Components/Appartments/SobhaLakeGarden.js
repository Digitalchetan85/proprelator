...
import SobhaLakeGardenSlider from "./Slider/SobhaLakeGardenSlider";


export default function SobhaLakeGarden() {
  return (
    <div>
      <SobhaLakeGardenSlider />
      <div id="content" className="pt-2 pb-2 pt-md-5 pb-md-5">
        <Container>
          <Row className="justify-content-center">
            <Col md={8}>
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <h3>About Sobha Lake Garden</h3>
                <p>Sobha Lake Garden is the new residential Apartment project launched in KR Puram, Bangalore.</p>
                <p>The residential enclave Sobha Lake Garden features the very best in SOBHA Limited’s luxury living segment. The project offers spacious Apartments with luxurious features.</p>
                <p>Beautiful landscapes all around Sobha Lake Garden makes it more special & Elite.</p>
                <p>The builder is guaranteed to bring a quality living experience to the community of KR Puram, East Bangalore with brilliant architecture and equivalent lifestyle in Sobha Lake Garden.</p>
                <p>Sobha Lake Garden Location has excellent connectivity & it is located at the crux of KR Puram near existing and upcoming communities & facilities.</p>
                <p>Amenities at Sobha Lake Garden include a fully equipped clubhouse, landscaped gardens, gymnasium, swimming pool, recreation rooms, outdoor sports courts, children’s play area, party hall, and meticulously planned with utmost importance to state-of-the-art 24/7 securities.</p>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>8.89 Acres</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>9 Blocks 2B+G+18 Floors</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>Ph 1: 2023 Onwards, Ph 2: Mar 2024 Onward</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                </Row>
              ...
              <Row>
                  <h2 className="pb-2">Sobha Dream Gardens Amenities</h2>
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Gymnasium</li>
