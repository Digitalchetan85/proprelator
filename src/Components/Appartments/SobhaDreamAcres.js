...
import SobhaDreamAcresSlider from './Slider/SobhaDreamAcresSlider';


export default function SobhaDreamAcres() {
  return (
    <div>
      <SobhaDreamAcresSlider />
      <div id="content" className="pt-2 pb-2 pt-md-5 pb-md-5">
        <Container>
          <Row className="justify-content-center">
            <Col md={8}>
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <h3>About Sobha Dream Acres</h3>
                <p>Sobha Dream Acres is the new residential Apartment project launched in Panathur Road, Varthur, Bangalore.</p>
                <p>The residential enclave Sobha Dream Acres features the very best in SOBHA Limited’s luxury living segment. The project offers spacious Apartments with luxurious features.</p>
                <p>Beautiful landscapes all around Sobha Dream Acres make it more special & Elite.</p>
                <p>The builder is guaranteed to bring a quality living experience to the community of Panathur Road, Varthur, East Bangalore with brilliant architecture and an equivalent lifestyle in Sobha Dream Acres.</p>
                <p>Sobha Dream Acres Location has excellent connectivity & it is located at the crux of Panathur Road, Varthur near existing and upcoming communities & facilities.</p>
                <p>Amenities at Sobha Dream Acres include a fully equipped clubhouse, landscaped gardens, gymnasium, swimming pool, recreation rooms, outdoor sports courts, children’s play area, party hall, and meticulously planned with utmost importance to state-of-the-art 24/7 securities.</p>
              ...
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <Row>
                  <h2 className="pb-2">Sobha Dream Acres Configuration</h2>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      {/* <Image src={Image2}  alt="" className="img-fluid"/> */}
                      <Card.Body>
                        <Card.Title>Project Location</Card.Title>
                        <Card.Text>Balagere-Panathur Road, Varthur</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>6500 Units</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>67 Blocks B+G+13 Floors</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
              ...
              <Row>
                  <h2 className="pb-2">Sobha Dream Acres Amenities</h2>
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Gymnasium</li>
                  ...
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Outdoor Courtsl</li>
                        <li>Table Tennis</li>
                        <li>Landscaped Acres</li>
                ...
                {/* <Row>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        <Card.Title>Landscaped Acres</Card.Title>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
              ...
              <div className="pb-2 pb-md-5">
                  <Row>
                      <Col md={12}>
                          <h2 className="pb-2">About the Builder – Sobha Developers</h2>
