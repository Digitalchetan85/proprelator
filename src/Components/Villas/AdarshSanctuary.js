...
import AdarshSanctuarySlider from "./slider/AdarshSanctuarySlider";


export default function AdarshSanctuary() {
  return (
    <div>
      <AdarshSanctuarySlider />
      <div id="content" className="pt-2 pb-2 pt-md-5 pb-md-5">
        <Container>
          <Row className="justify-content-center">
            <Col md={8}>
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                  <h2>About Adarsh Sanctuary</h2>
                <p>Adarsh Sanctuary is a brand new residential villa project by Adarsh Group in the rapidly expanding neighborhood of Sarjapur Road, Bangalore.</p>
                <p>The residential enclave, Sanctuary features the very best in the Adarsh Group luxury segment. The project offers spacious villas with luxurious features.    </p>
                <p>Beautiful landscapes all around Adarsh Sanctuary make it more special & Elite.</p>
                <p>The builder is guaranteed to bring a quality living experience to the community of Sarjapur Road with brilliant architecture and an equivalent lifestyle in Sanctuary.</p>
                <p>Adarsh Sanctuary Location has excellent connectivity & it is located at the heart of Kodathi near Carmelaram and Hadosiddapura off Sarjapur Road, East Bangalore.</p>
                <p>Amenities at Adarsh Sanctuary include a fully equipped clubhouse, landscaped gardens, gymnasium, swimming pool, recreation rooms, outdoor sports courts, children’s play area, party hall, and meticulously planned with utmost importance to state-of-the-art 24/7 securities.</p>
              ...
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <Row>
                  <h2 className="pb-2">Adarsh Sanctuary Configuration</h2>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      {/* <Image src={Image2}  alt="" className="img-fluid"/> */}
                      <Card.Body>
                        <Card.Title>Project Location</Card.Title>
                        <Card.Text>Avalahalli, Kodathi,  Off Sarjapur Road</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>G + 1 Floors</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>May 2023 Onwards</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                </Row>
              ...
              <Row>
                  <h2 className="pb-2">Adarsh Sanctuary Amenities</h2>
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Gymnasium</li>
              ...
              <div className="pb-2 pb-md-5">
                  <h3>Adarsh Sanctuary Villas Price</h3>
                <Table
                  responsive="sm"
                  className="table-bordered align-middle text-center"
                >
