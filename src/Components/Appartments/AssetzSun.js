...
import AssetzSunSlider from "./Slider/AssetzSunSlider";


export default function AssetzSun() {
  return (
    <div>
      <AssetzSunSlider />
          ...
          <Row className="justify-content-center">
            <Col md={8}>
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <h3>About Assetz 38 and Banyan</h3>
                <p>Assetz 38 & Banyan is the Ready to Move-In Ultra Luxury residential Apartment project launched in CV Raman Nagar, Bangalore.</p>
                <p>The residential enclave Assetz 38 and Banyan feature the absolute best in Assetz Group’s fine luxury living segment. The project offers a very limited number of spacious 3,4 BHK Apartments with luxurious features.</p>
                <p>Beautiful landscapes, over 75% Open spaces, some of Bangalore & even South India’s key landmarks all around, and surrounding a 150-year old Banyan tree Assetz 38 & Banyan make it more special & Elite.</p>
                <p>The builder is guaranteed to bring a quality living experience to the elite & exclusive community of CV Raman Nagar right beside Indiranagar in Central East Bangalore with brilliant architecture and equivalent lifestyle in Assetz 38 and Banyan.</p>
                <p>Assetz 38 & Banyan Location has excellent connectivity to almost every other part of Bangalore & it is located just off CV Raman Nagar, East Bangalore near Indiranagar, Domlur, Defense colony, MG Road, Marathahalli, and more facilities & communities.</p>
                <p>Some of the Amenities at Assetz 38 and Banyan include a fully equipped clubhouse, landscaped gardens, gymnasium, swimming pool, recreation rooms, outdoor sports courts, children’s play area, party hall, and meticulously planned with utmost importance to state-of-the-art 24/7 securities.
import AssetzSun from './AssetzSun';
import AssetzSunSlider from './Slider/AssetzSunSlider';
              ...
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <Row>
                  <h2 className="pb-2">Assetz 38 & Banyan Configuration</h2>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      {/* <Image src={Image2}  alt="" className="img-fluid"/> */}
                      <Card.Body>
                        <Card.Title>Project Location</Card.Title>
                        <Card.Text>CV Raman Nagar, off Indiranagar</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>38 Luxury, Apartments</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>Single Tower, G + 10 Floors</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>Apr 2021 Onwards</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                </Row>
              ...
              <Row>
                  <h2 className="pb-2">Assetz 38 & Banyan Amenities</h2>
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Gymnasium</li>
                  ...
                  <Col md={6}>
                    <div className="">
                      <ul>
                        ...
                        <li>BBQ Area</li>
                        <li>Yoga & Aerobics Area</li>
                        <li>Creative Corner, Reading Lounge</li>
                      </ul>
                    </div>
                  </Col>
                </Row>
