...
import GodrejAnandaSlider from "./Slider/GodrejAnandaSlider";


export default function GodrejAnanda() {
  return (
    <div>
      <GodrejAnandaSlider />
          ...
          <Row className="justify-content-center">
            <Col md={8}>
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <h3>About Godrej Ananda</h3>
                <p>The massive residential enclave, Godrej Ananda features the very best in Godrej Properties’ premium living segment. The project offers spacious 1,2,3 BHK Apartments with luxurious features.</p>
                <p>The massive residential enclave, Godrej Ananda features the very best in Godrej Properties’ premium living segment. The project offers spacious 1,2,3 BHK Apartments with luxurious features.</p>
                <p>Beautiful landscapes all around Godrej Ananda with over 2 acres of parks and open spaces make it more special & Elite.</p>
                <p>The builder is guaranteed to bring a quality living experience to the community of Gummanahalli, Bagalur, North Bangalore with brilliant architecture and an equivalent lifestyle in Ananda.</p>
                <p>Godrej Ananda Location has excellent connectivity & it is located at the crux of BK Halli Road very close to Bagalur Aerospace Park, Gummanahalli, Bagalur near existing and upcoming communities & facilities.</p>
                <p>Some of the 25+ Amenities at Godrej Ananda include a fully equipped clubhouse, landscaped gardens, gymnasium, swimming pool, recreation rooms, outdoor sports courts, children’s play area, AV Room, party hall, and meticulously planned with utmost importance to state-of-the-art 24/7 securities.</p>
              ...
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <Row>
                  <h2 className="pb-2">Godrej Ananda Configuration</h2>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      {/* <Image src={Image2}  alt="" className="img-fluid"/> */}
                      <Card.Body>
                        <Card.Title>Project Location</Card.Title>
                        <Card.Text>BK Halli Road, Bagalur, Gummanahalli</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>3B + G + 29 Floors</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>Dec 2025 Onwards </Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                </Row>
              ...
              <Row>
                  <h2 className="pb-2">Godrej Ananda Amenities</h2>
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Gymnasium</li>
                  ...
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Sports Courts</li>
                        <li>Meditation, Zumba, Activity Area</li>
                        <li>Landscaped Gardens</li>
                        <li>Kids Play Area</li>
                        <li>Mini Theatre</li>
                        <li>Amphitheatre & Party Areas</li>
                      </ul>
                    </div>
                  </Col>
                </Row>
              ...
              <div className="pb-2 pb-md-5">
                  <h3>Godrej Ananda Launch Price</h3>
                <Table
                  responsive="sm"
                  className="table-bordered align-middle text-center"
                >
                  <thead className="bg-primary text-white">
                    <tr>
                      <th>Unit Type</th>
                      <th>Size in Sq.Ft</th>
                      <th>Approx. Final Price Range</th>
              ...
              <div className="pb-2 pb-md-5">
                  <Row>
                      <Col md={12}>
                          <h2 className="pb-2">About the Builder – Godrej Properties</h2>
                          <p>Godrej Properties brings the Godrej Group philosophy of innovation, sustainability, and excellence to the real estate industry. Each Godrej Properties development combines a 119–year legacy of excellence and trust with a commitment to cutting-edge design and technology. Godrej Properties is currently developing residential, commercial and township projects spread across approximately 11.89 million square meters in 12 cities.</p>
                          <p>In the last 3 years, Godrej Properties has received over 150 awards and recognitions, including the “Real Estate Company Of The Year” at the Construction Week India Awards 2015, ‘Golden Peacock Award for Sustainability’ for the year 2015 by Institute Of Directors (IOD), “Most Reliable Builder for 2014” at the CNBC AWAAZ Real Estate Awards 2014, “Innovation Leader in Real Estate” award at the NDTV Property Awards 2014 and “Popular Choice – Developer of the Year” award by ET NOW in 2013.</p>
                      </Col>
                  </Row>
              </div>
            </Col>
