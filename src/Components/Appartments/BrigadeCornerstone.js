...
import BrigadeCornerstoneSlider from './Slider/BrigadeCornerstoneSlider';

export default function BrigadeCornerstone() {
  return (
    <div>
      <BrigadeCornerstoneSlider  />
      <div id="content" className="pt-2 pb-2 pt-md-5 pb-md-5">
        <Container>
          <Row className="justify-content-center">
            <Col md={8}>
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <h3>About Brigade Cornerstone Utopia</h3>
                <p>Brigade Cornerstone Utopia is the new residential Apartment project launched in Varthur Road, Bangalore.</p>
                <p>The residential enclave Brigade Cornerstone Utopia features the very best in Brigade Group’s luxury living segment. The project offers spacious Apartments with luxurious features.</p>
                <p>Beautiful landscapes all around Brigade Cornerstone Utopia makes it more special & Elite.</p>
                <p>The builder is guaranteed to bring a quality living experience to the community of Varthur Road, East Bangalore with brilliant architecture and equivalent lifestyle in Brigade Cornerstone Utopia.</p>
                <p>Brigade Cornerstone Utopia Location has excellent connectivity & it is located at the crux of Varthur Road – Balagere Road near existing and upcoming communities & facilities.</p><p>Amenities at Brigade Cornerstone Utopia include a fully equipped clubhouse, landscaped gardens, gymnasium, swimming pool, recreation rooms, outdoor sports courts, children’s play area, party hall, and meticulously planned with utmost importance to state-of-the-art 24/7 securities.</p>
              ...
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <Row>
                  <h2 className="pb-2">Brigade Cornerstone Utopia Configuration</h2>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      {/* <Image src={Image2}  alt="" className="img-fluid"/> */}
                      <Card.Body>
                        <Card.Title>Project Location</Card.Title>
                        <Card.Text>Varthur Road </Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>4000 Units</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>12 Blocks G + 26 Floors</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>Studio,1,2,3 BHK</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text> 2024 Onwards </Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                </Row>
              ...
              <Row>
                  <h2 className="pb-2">Brigade Cornerstone Utopia Amenities</h2>
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Gymnasium</li>
              ...
              <div className="pb-2 pb-md-5">
                  <h3>Brigade Cornerstone Utopia Price</h3>
                <Table
                  responsive="sm"
                  className="table-bordered align-middle text-center"
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>2 BHK Tranquil</td>
                      <td>1259</td>
                      <td>Rs. 85 Lacs Onwards</td>
                      <td>
                        <Button type="button" className="btn btn-primary">
                          Download
                        </Button>
                    ...
                    <tr>
                      <td>2.5 BHK Tranquil</td>
                      <td>1389 to 1404</td>
                      <td>Rs. 94 Lacs Onwards</td>
                      <td>
                        <Button type="button" className="btn btn-primary">
                          Download
                        </Button>
                    ...
                    <tr>
                      <td>3 BHK Tranquil</td>
                      <td>1667 to 18971389 to 1404</td>
                      <td>	Rs. 1.11 Crore Onwards</td>
                      <td>
                        <Button type="button" className="btn btn-primary">
                          Download
                        </Button>
