...
import PreWhiteMedSlider from "./slider/PreWhiteMedSlider";
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>Whitefield, Bangalore</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>128.5 Acres</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>288 Sky Villas 61 Bungalows</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>4 Towers G + 27 Floors</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
