...
import HiranandaniSlider from "./slider/HiranandaniSlider";


export default function Hiranandani() {
  return (
    <div>
      <HiranandaniSlider />
          ...
          <Row className="justify-content-center">
            <Col md={8}>
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <h3>About Hiranandani Devanahalli Cottages</h3>
                <p>Hiranandani Devanahalli Cottages is the new residential Cottage Villa project launched in Devanahalli, Airport Road, Bangalore.</p>
                <p>The residential enclave Hiranandani Devanahalli Cottages features the very best in House of Hiranandani’s quality and luxury living segment. The project offers spacious Cottage Villas with luxurious features.</p>
                <p>Beautiful landscapes all around Hiranandani Devanahalli Cottages makes it more special & Elite.</p>
                <p>The builder is guaranteed to bring a quality living experience to the community of Devanahalli, Airport Road, North Bangalore with brilliant architecture and equivalent lifestyle in Hiranandani Devanahalli Cottages.</p>
                <p>Hiranandani Devanahalli Cottages Location has excellent connectivity & it is located at the crux of Devanahalli, Airport Road near existing and upcoming communities & facilities.</p>
                <p>Amenities at Hiranandani Devanahalli Cottages include a fully equipped clubhouse, landscaped gardens, gymnasium, swimming pool, recreation rooms, outdoor sports courts, children’s play area, party hall, and meticulously planned with utmost importance to state-of-the-art 24/7 securities.</p>
              ...
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <Row>
                  <h2 className="pb-2">Hiranandani Cottages Configuration</h2>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      {/* <Image src={Image2}  alt="" className="img-fluid"/> */}
                      <Card.Body>
                        <Card.Title>Project Location</Card.Title>
                        <Card.Text>Devanahalli, Airport Road</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
              ...
              <Row>
                  <h2 className="pb-2">Hiranandani Devanahalli Cottages Amenities</h2>
                  <Col md={6}>
                    <div className="">
                      <ul>
                        <li>Gymnasium</li>
              ...
              <div className="pb-2 pb-md-5">
                  <h3>Hiranandani Devanahalli Cottages Price</h3>
                <Table
                  responsive="sm"
                  className="table-bordered align-middle text-center"
                >
              ...
              <div className="pb-2 pb-md-5">
                  <Row>
                      <Col md={12}>
                          <h2 className="pb-2">About the Builder – House of Hiranandani</h2>
                          <p>For the last three decades, the Hiranandanis have been single-handedly altering the ethos and aesthetics of real estate in India. The group has built multi-use developments in India on a large scale and have introduced retail, hospitality, healthcare, education and entertainment into their developments. With a unique approach to engineering, planning, and design, the Hiranandanis invest heavily in research and development to ensure they remain at the forefront of value engineering and design.</p>
