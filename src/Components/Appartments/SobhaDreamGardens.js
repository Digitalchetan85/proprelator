...
import SobhaDreamGardensSlider from "./Slider/SobhaDreamGardensSlider";


export default function SobhaDreamGardens() {
  return (
    <div>
      <SobhaDreamGardensSlider />
      <div id="content" className="pt-2 pb-2 pt-md-5 pb-md-5">
        <Container>
          <Row className="justify-content-center">
            <Col md={8}>
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <h3>About Sobha Dream Gardens</h3>
                <p>Sobha Dream Gardens is a new residential Apartment project in Bellahalli, Thanisandra – Kogilu Road, Bangalore.</p>
                <p>The residential enclave, Sobha Dream Gardens features the very best in Sobha Developers luxury segment. The project offers spacious Apartments with luxurious features.</p>
                <p>Beautiful landscapes all around Dream Gardens and the Japanese – Buddhist architectural style of “Zen Design” make it more special & Elite.</p>
                <p>The builder is guaranteed to bring a quality living experience to the community of Thanisandra with brilliant architecture and an equivalent lifestyle in Dream Gardens.</p>
                <p>Sobha Dream Gardens Location has excellent connectivity & it is located at the heart of North Bangalore at the crux of Kogilu – Thanisandra Road.</p>
                <p>Amenities at Sobha Dream Gardens include a fully equipped clubhouse, landscaped Gardenss, gymnasium, swimming pool, recreation rooms, outdoor sports courts, children’s play area, party hall, and meticulously planned with utmost importance to state-of-the-art 24/7 securities.</p>
              ...
              <div className="pt-2 pb-2 pt-md-5 pb-md-5 m-1">
                <Row>
                  <h2 className="pb-2">Sobha Dream Gardens Configuration</h2>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      {/* <Image src={Image2}  alt="" className="img-fluid"/> */}
                      <Card.Body>
                        <Card.Title>Project Location</Card.Title>
                        <Card.Text>Thanisandra</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>17 Acres (32 Acrea Total)</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>2000+ Units</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>10 Blocks 2B+G+23 Floors</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                  <Col md={4}>
                  ...
                  <Col md={4}>
                    <Card className="text-center m-1">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>Jul 2025 Onwards</Card.Text>
                      </Card.Body>
                    </Card>
                  </Col>
                </Row>
              ...
              <div className="pb-2 pb-md-5">
                  <h3>Sobha Dream Gardens Price</h3>
                <Table
                  responsive="sm"
                  className="table-bordered align-middle text-center"
                >
